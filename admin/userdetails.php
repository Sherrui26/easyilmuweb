...
<?php
                           ...
                           <table class="zui-table" id = "tables">
                                  <thead>
                                    <tr>
                                      <th>Name: </th>
                                      <td>&nbsp;&nbsp;<?php echo $name ?></td></tr><tr>
                                      <th>Username: </th>
                                      <td>&nbsp;&nbsp;<?php echo $rno ?></td></tr><tr>
                                      <th>Email: </th>    
                                      <td>&nbsp;&nbsp;<?php echo $email ?></td></tr>  <tr>                                
                                      <th>Mobile No: </th>
                                      <td>&nbsp;&nbsp;<?php echo $mobno ?></td></tr>
                                  </thead>
                                  <tbody>                             
                        ...
                        <a href="manageuser.php" class="button1">Go Back</a>   
                        <a href="remove_student.php?id=<?php echo $rollno; ?>" class="button2" style="background: red; float:right;">Remove</a>                         
