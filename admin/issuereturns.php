...
<div class="main">
    <button onclick="window.location='issue_requests.php';" class="myButton"><image width="100px" src="img/issuing.png"></image><p>Issue Requests</p></button>
    <button onclick="window.location='renew_requests.php';" class="myButton"><image width="100px" src="img/renew.png"></image><p>Renew Request</p></button>
    <button onclick="window.location='return_requests.php';"class="myButton"><image width="100px" src="img/return.png"></image><p>Return Requests</p></button>
</div>
</body>
  </html>
<?php }
